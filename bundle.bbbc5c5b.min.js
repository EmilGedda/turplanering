...
`)),pt=(0,p.ZP)("span",{name:"MuiTouchRipple",slot:"Root",skipSx:!0})({overflow:"hidden",pointerEvents:"none",position:"absolute",zIndex:0,top:0,right:0,bottom:0,left:0,borderRadius:"inherit"}),dt=(0,p.ZP)((function(e){const{className:n,classes:i,pulsate:r=!1,rippleX:o,rippleY:a,rippleSize:s,in:l,onExited:c,timeout:h}=e,[p,f]=t.useState(!1),g=(0,u.Z)(n,i.ripple,i.rippleVisible,r&&i.ripplePulsate),y={width:s,height:s,top:-s/2+a,left:-s/2+o},m=(0,u.Z)(i.child,p&&i.childLeaving,r&&i.childPulsate);return l||p||f(!0),t.useEffect((()=>{if(!l&&null!=c){const t=setTimeout(c,h);return()=>{clearTimeout(t)}}}),[c,l,h]),(0,d.jsx)("span",{className:g,style:y,children:(0,d.jsx)("span",{className:m})})}),{name:"MuiTouchRipple",slot:"Ripple"})(st||(st=lt`
  opacity: 0;
  position: absolute;
